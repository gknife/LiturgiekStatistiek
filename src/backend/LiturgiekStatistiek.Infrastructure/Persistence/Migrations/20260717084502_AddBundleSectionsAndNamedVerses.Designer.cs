...
namespace LiturgiekStatistiek.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260717084502_AddBundleSectionsAndNamedVerses")]
    partial class AddBundleSectionsAndNamedVerses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiturgiekStatistiek.Domain.Entities.BundleSection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BundleId", "Value")
                        .IsUnique();

                    b.ToTable("BundleSections");
                });
            ...
            modelBuilder.Entity("LiturgiekStatistiek.Domain.Entities.CongregationPreacher", b =>
                {
                    ...
                    b.HasKey("CongregationId", "PreacherId");

                    b.HasIndex("PreacherId");

                    b.ToTable("CongregationPreachers");
                });
            ...
            modelBuilder.Entity("LiturgiekStatistiek.Domain.Entities.Preacher", b =>
                {
                    ...
                    b.HasOne("LiturgiekStatistiek.Domain.Entities.ListItem", "Title")
                        .WithMany()
